...
describe('Create and immediately delete user profiles', () => {
  ...
  it('Create and immediately delete Adult profile', async () => {
  ...
  it('Create and immediately delete TEEN profile in age range 15 - 17', async () => {
  ...
  it('Create and immediately delete TEEN profile in age range 12 - 14', async () => {
